...
SVM’s have been proven to be a powerful algorithm for supervised clustering. During the past few years, SVM has been applied very broadly within the field of computational biology especially in pattern recognition problems. The goal of SVM is to find a hyperplane $Y_i(b_0 + b_1X_i1 + b_2X_i_2) = 0$ that separates the nearest data as clean as possible. The parameters bi are found by solving the optimization problem below. 
...
is the perpendicular distance from the ith observation to the hyperplane. If it's >0, the observation falls at the right side of the hyperplane and vice versa.
