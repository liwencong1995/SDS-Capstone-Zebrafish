...
This project gives statistical analysis to the landmark data provided by the Barresi Lab at Smith College for the research on morphological structure and spatial relationships during nerves system development. Zebrafish is chosen to be the study sample, because it can be bred in a small laboratory space and is the fastest developing vertebrate model system. 
