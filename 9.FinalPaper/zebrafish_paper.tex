...
\item
  ...
  the midline
\item
  \(theta\) (radian): the degree the describes the location of a wedge
  within each slice
\end{itemize}
...
3. Wickham H, Francois R, Henry L, Müller K. Dplyr: A grammar of data
...
6. Chang W, Cheng J, Allaire J, Xie Y, McPherson J. Shiny: Web
