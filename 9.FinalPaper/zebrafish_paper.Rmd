...
knitr::include_graphics("figures/Figure1.jpg", dpi = 500 )
```
...
### User Interaction
```{r useri, fig.cap = "Example of User Interaction in Step One of the User Interface", fig.width= 5, fig.height=3, fig.align='center', echo=FALSE}
