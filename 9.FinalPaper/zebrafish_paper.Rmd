...
The slack variable $\varepsilon_i$ tells us where the $i^{th}$ observation is located, relative to the separation line and relative to the margin. If $\varepsilon_i = 0$ then the $i^{th}$ observation is on the correct side of the margin. If $\varepsilon_i > 0$ then the ith observation is on the wrong side of the margin. If $\varepsilon_i > 1$ then it is on the wrong side of the separation line.
...
In our analysis, we used number of points in each wedge within the 3D shape and the median $r$ of points in each wedge.
