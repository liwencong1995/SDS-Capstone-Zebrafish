...
The goal of SVM is to find a separation line $f(x) = (\beta_0 + \beta_1 \cdot x_1 + \beta_2 \cdot x_2)$ that separates the nearest data as cleanly as possible. The parameters $\beta$ are found by solving the optimization problem --to maximize M subject to some restrictions -- in 2 dimensions below. 
...
>>>>>>> ed9b652a3a2ea494f764f107d07616048d9dcc14
\begin{equation}
  \left.
  \begin{array}{l@{\,}l}
...
As shown in **Fig 3** and **Fig 4**, several user inputs are taken from users when they run the python scripts.
...
### Sample input file
<<<<<<< HEAD
```{r inputdata, fig.cap ="Sample Data Input File of First Step of the User Interface", fig.align='center', echo=FALSE}
knitr::include_graphics("figures/Figure3.png", dpi = 260 )
=======
