...
# Support Vector Machine 
The goal of SVM is to find a separation line $f(x) = (\beta_0 + \beta_1 \cdot x_1 + \beta_2 \cdot x_2)$ that separates the nearest data as cleanly as possible. The parameters $\beta$ are found by solving the optimization problem --to maximize M subject to some restrictions -- in 2 dimensions below [@James2013].

```{r svmfig, fig.cap = "SVM model", fig.align='center', echo=FALSE}
...
## General Workflow
```{r workflow, fig.cap = "Summary of Workflow", fig.align='center', echo=FALSE}
...
### Output File
```{r outputdata, fig.cap ="Sample Data Output File of First Step of the User Interface", fig.align='center', echo=FALSE}
knitr::include_graphics("figures/Figure4.png", dpi = 260 )
```
