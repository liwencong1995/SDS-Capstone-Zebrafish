...
## Step Two: Result Visualization -- Shiny App

### Input
Data must be stored in a folder callled data under your work directory, and the CSV file must be named as "output_data.csv". If you do not know what your work directory is, you can check it by using the function `getwd()`.
